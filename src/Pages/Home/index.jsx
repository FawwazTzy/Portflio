    ...
    >
      ...
      <div className="flex flex-col flex-1 w-full h-full ml-[20px] mr-[10px]">
        ...
        <div className="flex flex-1 w-full h-full">
          ...
          >
            <div className="flex w-full h-[160px]  rounded-xl border-[#258362] border-[2px] p-[10px]">
              <DataTOP />
            </div>
            <div
              style={{
              ...
              className="flex w-full rounded-xl border-[#258362] border-[2px] p-[10px] mt-[10px] mb-[10px]"
            >
              <DataBottom />
            </div>
          </div>
          <div
            ...
            className="flex w-[400px] rounded-xl border-[#258362] border-[2px] ml-[10px] mt-[20px]"
          >
            <TableRight />
          </div>
        </div>
